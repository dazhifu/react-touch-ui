...
export class PullList  extends React.Component {
    ...
    render() {
        ...
        let {pullDown, pullUp, pullDownText, pullUpText, className,  children,...props} = this.props;
                ...
                <View className="iscroll-body ">
                    ...
                    {pullUp ? (
                        <div className={classnames({'iscroll-pull-up': true, [pullUpCls]: true})}>
                            <i></i>
                            <span style={sx} >{pullUpText[pullUpState]}</span>
                        </div>
                    ) : null}
